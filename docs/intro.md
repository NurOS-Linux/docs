...
3. **Открытость и сообщество**
   * Весь код компонентов лицензирован под лицензиями FLOSS (обычно GNU GPL 3.0 и CC BY-SA 4.0)
...
## Лицензия
NurOS распространяется под лицензией GNU GPL v3.0. Вы можете свободно модифицировать и распространять систему в рамках условий лицензии.
